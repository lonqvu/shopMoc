import {
  ArrowRight, Check, ChevronDown, ChevronUp, Headphones, Heart, Leaf, Mail, MapPin, Menu, MessageCircle, Minus, Phone, Plus,
  Search, ShieldCheck, ShoppingBag, Star, Trash2, Truck, UserRound, X,
} from 'lucide-react'

const icons = {
  arrow: ArrowRight, cart: ShoppingBag, check: Check, chevronDown: ChevronDown, close: X,
